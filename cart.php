...
<html>
    ...
    <body>
       ...
       $user_id = $_SESSION["id"];
       $query = "SELECT p.id, p.details, p.price ,up.quantity,up.timeoforder FROM store.shop p INNER JOIN store.users_shop up ON up.item_id = p.id WHERE up.user_id = '$user_id' AND up.status = 'Added to cart'";
